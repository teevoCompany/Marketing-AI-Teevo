...
def main_app():
    #openai.api_key = secret_key.openai_api_key --- run this locally
    openai.api_key = st.secrets.OpenAIAPI.openai_api_key # -- this for deployment
    ...
    st.image("AI-Marketing/image.jpg")
